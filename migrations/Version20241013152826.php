 ...
 */
final class Version20241013152826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emploi ADD classe_id INT NOT NULL, DROP classe');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emploi ADD classe VARCHAR(255) NOT NULL, DROP classe_id');
    }
}
